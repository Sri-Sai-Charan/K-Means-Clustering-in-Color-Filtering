...
def main():
    img=cv.imread('Code/Media/Q4/Q4image.png')
    k1_cluster = [0,0,0]
    k2_cluster = [0,0,255]
    k3_cluster = [0,255,0]
    k4_cluster = [255,0,0]
    ...
    my_map = np.dstack((img,np.zeros((341, 281),dtype=np.uint8)))
    cluster_change_flag = []
    count = 0
    while True:
